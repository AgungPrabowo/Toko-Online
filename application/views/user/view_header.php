...
<html class="frontend">
    ...
    <head>
        ...
        <link rel="apple-touch-icon-precomposed" sizes="144x144" href="<?=base_url();?>assets/front-end/image/touch/apple-touch-icon-144x144-precomposed.png">
        ...
        <link rel="stylesheet" href="<?=base_url();?>assets/front-end/stylesheet/bootstrap.css">
        <link rel="stylesheet" href="<?=base_url();?>assets/front-end/stylesheet/layout.css">
        <link rel="stylesheet" href="<?=base_url();?>assets/front-end/stylesheet/uielement.css">
        <link rel="stylesheet" href="<?=base_url();?>assets/front-end/stylesheet/themes/layouts/fixed-header.css">
        <!--/ Application stylesheet -->

        <!-- modernizr script -->
        <script type="text/javascript" src="<?=base_url();?>assets/front-end/plugins/modernizr/js/modernizr.js"></script>
        <!--/ modernizr script -->
        <!-- END STYLESHEETS -->
    </head>
    <!--/ END Head -->
